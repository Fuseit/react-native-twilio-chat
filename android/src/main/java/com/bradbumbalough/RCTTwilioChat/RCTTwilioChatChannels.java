...
public class RCTTwilioChatChannels extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void createChannel(ReadableMap options, final Promise promise) throws JSONException {
        Log.d("CHANNEL CREATE OPTIONS", options.toString());
        final JSONObject attributes = convertMapToJson(options.getMap("attributes"));
        Log.d("CHANNEL CREATED", attributes.toString());
